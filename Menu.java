import java.awt.Container;
	...
	public class Menu  implements ActionListener {
	    ...
	    JLabel lblProduct,lblDescription,lblPrice,lblCategory,lblI,lblT,lblD,lblP,lblC,
...
//id integer Primary key,title varchar(255), description varchar(255), price varchar(255), category varchar(255)";
	    ...
	    JButton btnAdd,btnPrev,btnNext;

	    ResultSet rs;
	    private final JButton btnList_1 = new JButton(" List");
...
//	        }
...

	    {
...

	        {
				...
				String sql="CREATE TABLE IF NOT EXISTS Products(id integer Primary key AUTO_INCREMENT,title varchar(255), description varchar(255), price int, category varchar(255)";

	 

	            String sql1 = "INSERT INTO Products (title,description,price,category) " +
